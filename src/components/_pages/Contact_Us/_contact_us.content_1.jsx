...
import MobileView from "./mobile/_contact_us.content_1";
        ...
        <Container>
          <Grid container justifyContent="space-between">
            <Grid size={{ md: 5 }}>
              ...
              <Typography sx={{ mb: 2 }}>
                As an independent organization with big dreams, our door is
                always open for discussion. We welcome all forms of support from
                all external entities that share the same vision as ours.
              </Typography>

              <Typography sx={{ mb: 7 }}>
                Whether you are a part of an organization which wants to broaden
                the network, a company who puts sustainability on top of
                business concern, or just someone who cares about the better
                life of the future generation, this is the right time to act!
              </Typography>
            ...
            <Grid size={{ md: 5.5 }}>
              ...
              >
                <Typography color="#fff" variant="h6" sx={{ mb: 2 }}>
                  Let’s explore possible opportunities to create <br />{" "}
                  something together and be a part of the <br /> solution.
                </Typography>
