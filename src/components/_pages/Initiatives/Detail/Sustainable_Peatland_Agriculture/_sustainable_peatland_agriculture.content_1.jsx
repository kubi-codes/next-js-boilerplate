...
import MobileView from "./mobile/_sustainable_peatland_agriculture.content_1";
...
function _food_security_content_1() {
  ...
  return (
    <>
      <Box mb="150px" mt="150px" display={isMobile ? "none" : "block"}>
        <Container>
          ...
          <Grid container justifyContent="space-between" mt="80px">
            <Grid size={{ md: 3 }}>
              <Typography>
                ...
                letting it leave back to the ocean. <br />
                <br />
